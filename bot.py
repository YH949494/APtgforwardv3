...
# 🐞 Debug handler (logs all updates so we can see if Telegram sends anything)
...
if __name__ == "__main__":
    ...
    # Handlers
    app.add_handler(ChannelPostHandler(copy_message_handler))  # ✅ correct for channel posts
